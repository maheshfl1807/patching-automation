namespace IssueReportService.Data
{
    ...
    /// <inheritdoc />
    public class IssueReportServiceContext : DbContext
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueReportServiceContext"/> class.
        /// </summary>
        public IssueReportServiceContext()
        {
        ...
        public IssueReportServiceContext(DbContextOptions dbContextOptions)
